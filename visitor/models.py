...
class Visitor(models.Model):
    ...
    head_icon = models.ImageField(upload_to="visitor", default="visitor/default_head_icon.ico")
    user_center_cover = models.ImageField(upload_to="visitor/user_center", default="visitor/user_center/default.svg")
