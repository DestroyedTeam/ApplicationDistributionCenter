...
def user_detail_page(request):
    if request.method == "GET":
        ...
        try:
            ...
            return render(request, "404.html", {"code": 404, "err": "failed with wrong user or invalid params value"})
        except TypeError:
            return render(request, "404.html", {"code": 402, "err": "failed with wrong user or invalid params"})
        except Exception as e:
        ...
        if user_id:
            ...
            return render(request, "404.html", {"code": 404, "err": "request succeed, failed with no matched user"})
